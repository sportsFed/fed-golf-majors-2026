...
import { setSession, hashPin, verifyPin } from "@/lib/auth";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "var(--fairway-dark)" }}>
      {/* Background decoration */}
      <div style={{
        position: "fixed", inset: 0, zIndex: 0,
        background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(26,66,41,0.5) 0%, transparent 70%)"
      }} />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "2rem", color: "#f0faf4", fontWeight: 700, marginBottom: 6 }}>
            Fed Golf Majors
          </h1>
          <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", fontFamily: "'DM Mono', monospace" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
              <input
                ...
                style={{ accentColor: "var(--green-400)" }}
              />
            ...
            <button
              ...
              style={{ marginTop: 4, padding: "12px", fontSize: "1rem" }}
        ...
        <p style={{ textAlign: "center", color: "var(--text-muted)", fontSize: "0.8rem", marginTop: 20 }}>
          Questions? Contact your pool commissioner.
        </p>
      </div>
    </div>
  );
